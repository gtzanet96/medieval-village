...
public class NPCDialogue2 : MonoBehaviour {
	...
	bool inChat = false; // να ενεργοποιειται/απενεργοποιειται οταν βρισκομαστε εντος η εκτος του chat window αντιστοιχα
	...
	void Update () {
		if (NPCDialogue.mission == 1 || NPCDialogue.mission == 2) {
